...
export function LoginForm() {
  ...
  const [isGithubDirecting, setIsGithubDirecting] = useState<boolean>(false);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        <Button onClick={handleGitHubLogin} disabled={isLoading} variant="outline" className="w-full bg-transparent">
          {isGithubDirecting ? (
            <>
              <Spinner />
              <p>Redirecting...</p>
